...
if (!fs.existsSync(INPUT)) {
  ...
  console.error("    Download: https://www.kaggle.com/datasets/joebeachcapital/30000-spotify-songs");
  process.exit(1);
}
...
console.log(`✅  server/db.json written (${(fs.statSync(OUTPUT).size / 1_048_576).toFixed(1)} MB)`);
